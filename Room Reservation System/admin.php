...
?>
	...
	<aside id="sidebar" class="column">
		...
		<h3>Management</h3>
		<ul class="toggle">
			<li class="icn_new_article"><a href="all-res.php" name="Manage Reservations" target="MainPage" onclick="javascript: changeTag(this)">Reservations</a></li>
			<li class="icn_edit_article"><a href="all-user.php" name="Manage Users" target="MainPage" onclick="javascript: changeTag(this)">Users</a></li>
		</ul>
		<h3>Settings</h3>
		<ul class="toggle">
