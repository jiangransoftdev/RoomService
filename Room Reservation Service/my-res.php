	...
	if (r==true)
	  {
			...
			location.href="return-my-res.php?q="+str;
...
where user.user_id=reservation.user_id and reservation.room_id=room.room_id and user.user_id='".$myid."' and reservation.date>='".$today.
"' and reservation.start_hour>'".$hour."'";
...
?>
	...
	<header><h3 class="tabs_involved2">My Reservation</h3></header>
